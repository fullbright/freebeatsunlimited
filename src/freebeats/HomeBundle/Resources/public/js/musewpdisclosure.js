...
*/
(function(a,c,b){b.Plugins.TabbedPanelsPlugin={defaultOptions:{widgetClassName:"TabbedPanelsWidget",tabClassName:"TabbedPanelsTab",tabHoverClassName:"TabbedPanelsTabHover",tabDownClassName:"TabbedPanelsTabDown",tabActiveClassName:"TabbedPanelsTabSelected",panelClassName:"TabbedPanelsContent",panelActiveClassName:"TabbedPanelsContentVisible",defaultPanel:0,canCloseAll:!1},initialize:function(b,f){var g=this;a.extend(f,a.extend({},g.defaultOptions,f));c.Widget.Disclosure.DisplayPropertyTransitionPlugin.initialize(b,
f);b.bind("attach-behavior",function(){g._attachBehavior(b)})},_attachBehavior:function(a){var b=a.tabs?a.tabs.$element:null;if(b&&(b.first().addClass("TabbedPanelsTabFirst"),b.last().addClass("TabbedPanelsTabLast"),a.options.event!=="click"))b.on(a.options.event,function(){a.tabs.selectTab(this)})}};b.Plugins.AccordionPlugin={defaultOptions:{widgetClassName:"AccordionWidget",tabClassName:"AccordionPanelTab",tabHoverClassName:"AccordionPanelTabHover",tabDownClassName:"AccordionPanelTabDown",tabActiveClassName:"AccordionPanelTabOpen",
panelClassName:"AccordionPanelContent",panelActiveClassName:"AccordionPanelContentActive",defaultPanel:0,canCloseAll:!1,transitionDirection:"vertical"},initialize:function(b,f){var g=this;a.extend(f,a.extend({},g.defaultOptions,f));f.defaultIndex=f.defaultPanel;f.toggleStateEnabled=f.canCloseAll;c.Widget.Disclosure.AccordionTransitionPlugin.initialize(b,f);b.bind("transform-markup",function(){g._transformMarkup(b)});b.bind("attach-behavior",function(){g._attachBehavior(b)})},_transformMarkup:function(a){var b=
