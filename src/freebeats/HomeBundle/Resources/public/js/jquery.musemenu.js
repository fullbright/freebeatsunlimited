...
*/
(function(a){a.fn.museMenu=function(){return this.each(function(){var c=a(this),b="absolute",d,f,g,h,i;if(c.css("position")=="fixed")b="fixed",d=c.css("top"),f=c.css("left"),g=c.css("right"),h=c.css("bottom"),i=parseInt(c.css("margin-left"));else for(var j=c.parent();j.length>0&&j.attr("id")!="page";){if(j.css("position")=="fixed"){var b="fixed",k=j.offset(),n=c.offset(),l=j.css("top"),m=j.css("left"),o=j.css("right"),p=j.css("bottom");d=l!="auto"?parseInt(l)+(n.top-k.top):l;f=m!="auto"&&m.indexOf("%")==
